...
def question_obj_create():
    ...
    list_question_1 = Question(["list = ['The cat knows code', 'She worked as a Project Manager before attending DigitalCrafts', 'Today is not yesterday!']", "clue1 = (list[0])", "clue2 = (list[0])", "clue3 = (list[1])", "clue4 = (list[2])", "print(clue1[0:4] + clue2[14:18] + clue3 [3:10] + clue4[13:24])"], "The code worked yesterday!",LVL_1_PROMPT)
