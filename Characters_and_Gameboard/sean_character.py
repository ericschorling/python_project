...
class Player(pygame.sprite.Sprite):
    def __init__(self,name, shirt_color, catch_phrase ):
        ...
        self.surf = pygame.image.load("Sean_Front.png").convert()
    ...
    def update(self, pressed_keys):
        if pressed_keys[K_UP]:
            ...
            self.surf = pygame.image.load("Sean_Jumping_Right.png").convert()
            self.surf.set_colorkey((0,0,0), RLEACCEL)
        ...
        if pressed_keys[K_LEFT]:
            ...
            self.surf = pygame.image.load("Sean_Walking_Left.png").convert()
            self.surf.set_colorkey((0,0,0), RLEACCEL)
        if pressed_keys[K_RIGHT]:
            self.rect.move_ip(5, 0)
            self.surf = pygame.image.load("Sean_Walking_Right.png").convert()
            self.surf.set_colorkey((0,0,0), RLEACCEL)
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load('Pygame_Practice_Bullet.png').convert()
...
background_image = pygame.image.load('Pygame_Practice_Background.png').convert()
